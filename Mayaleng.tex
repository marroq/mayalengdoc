...
\begin{table}[H]
	...
	\hline
	Traducci\'on de oraciones  & \checkmark & x & \checkmark & \checkmark\\
	\hline
	Traducci\'on precisa & \checkmark & x & \checkmark & x\\
	\hline
	Herramienta de traducci\'on de sitios web & \checkmark & x & x & \checkmark\\
	\hline
	\end{tabular}}
...
\begin{table}[H]
	...
	\hline
	Siempre disponible & \checkmark & x & x & x\\
	\hline
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1.0\textwidth]{arquitecturalogos}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1.1\textwidth]{secuenciaidiomas}
